...
if [[ "$1" == "backend" ]] ; then
  ...
  envVariable2="REACT_APP_MONGODB_URI=mongodb://$3@docdb-sandbox.c9qzwnhx4tes.eu-west-1.docdb.amazonaws.com:27017/vacationer-app-database?tls=true&tlsCAFile=rds-combined-ca-bundle.pem&retryWrites=false"
