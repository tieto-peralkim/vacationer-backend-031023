...
docker run -d -p $PORTS -e "$ENV1" -e "$ENV2" -e "$ENV3" -e "$ENV4" -e "$ENV5" -e "$ENV6" --name=vacationer-"$INSTANCE" 629517020360.dkr.ecr.eu-west-1.amazonaws.com/ecr-vacationer-"$INSTANCE":latest
